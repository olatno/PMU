...
public class MaterialPaymentDetails extends  JFrame implements ActionListener, ListSelectionListener{//ItemListener implements Serializable, ActionListener
    ...
    public MaterialPaymentDetails(String title, Outgoingview view) {
	super(title);
	this.view = view;
    ...
    public void valueChanged(ListSelectionEvent e) {
		...
		if(maintablerow > 0 && maintablerow <= pu.arrayListOfObjects(paymentId).size()){
			type.setText(String.valueOf(pu.arrayListOfObjects(paymentId).get(maintablerow-1).get(3)));
			note.setText(String.valueOf(pu.arrayListOfObjects(paymentId).get(maintablerow-1).get(4)));
		}
		else{
			type.setText("");
			note.setText("");
